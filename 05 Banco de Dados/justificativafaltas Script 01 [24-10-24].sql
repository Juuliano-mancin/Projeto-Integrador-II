...
CREATE TABLE tb_reposicao (
    ...
    tipo ENUM('aula', 'atividade', 'outros') NOT NULL,
    data_criacao TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);



CREATE TABLE tb_reposicao_detalhes (
    id INT AUTO_INCREMENT PRIMARY KEY,
    ...
    FOREIGN KEY (id_reposicao) REFERENCES tb_reposicao(id),
    FOREIGN KEY (disciplina) REFERENCES tb_disciplinas(iddisciplina)
);
