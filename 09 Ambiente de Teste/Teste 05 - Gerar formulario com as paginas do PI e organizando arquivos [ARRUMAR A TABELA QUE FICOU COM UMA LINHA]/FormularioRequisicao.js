...
function saveRequisicaoData() {
    const curso = document.getElementById('cursos').value;
    const dataInicial = document.getElementById('data-inicial').value;
    const dataFinal = document.getElementById('data-final').value;
    const justificativa = document.querySelector('input[name="justificativa"]:checked')?.nextElementSibling.innerText || "";
    ...
    localStorage.setItem('requisicaoData', JSON.stringify(requisicaoData));
}
