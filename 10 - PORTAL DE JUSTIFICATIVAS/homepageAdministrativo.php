                            ...
                            <?php
                                ...
                                while ($linha = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                    ...
                                    if ($linha['statusrequisicao'] === 'aprovado') {
                                        ...
                                        echo "Finalizado";  // Remover o negrito
                                    } else {
                                    ...
                                    if ($linha['statusrequisicao'] === 'aprovado') {
                                        echo "<form action='finalizarRequisicao.php' method='POST'>
                                                ...
                                                <button type='submit' style='all: unset; cursor: pointer;' class='btnConsultar'><img src='img/Icones/check.svg' alt='Finalizar' class = 'icon'></button>
                                            </form>";
                                    } elseif ($linha['statusrequisicao'] === 'finalizado') {
                                        // Não exibe nada quando o status for 'finalizado'
                                        echo "";
                                    } else {
                                        echo "-";
                                    }
